...
public class ProjetDAO {
    ...
    /**
     * Trouver tous les projets dont le titre contient la chaine de caractères
     * passée en paramètre
     * 
     * @param titre
     * @return
    ...
    public List<Projet> findByCategorie( String categorie ) throws DAOException {
        try {
            Query query = em
                    .createQuery( "SELECT p FROM Projet p WHERE p.categorie.titreCategorie=?1 ORDER BY p.idProjet" );
