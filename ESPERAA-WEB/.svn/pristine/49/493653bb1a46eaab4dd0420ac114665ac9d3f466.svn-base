...
<div class="container">
    <div class="row">
        <form action="ModifProjet" method="post" role="form"  enctype="multipart/form-data">
            <div class="col-md-offset-3 col-md-6">
				...
				<fieldset class="greyBack bottomMargined">
					<legend class="greyBack">Ajout Tranche :</legend>
            ...
            <input type="submit" value="Modifier le projet" name="action" class="btn btn-info col-md-4 col-md-offset-4 bottomMargined"/>
            </div>
        </form>
